...
namespace TPVLib.implementations
{
    public class RAMDatabase : IDatabase
    {
        ...
        public long AddTicket(Ticket ticket)
        {
            ...
            // Javi: Bueno, ..., esto no tienes por qué hacerlo
            ticket.Header.TicketId = id;
            // Javi: Falta el id que hay en el body
        ...
        // Javi: En esencia esta función no debería existir
        ...
        // Javi: Tampoco entiendo mucho esta otra
        ...
        public void AddTicketLineWithId(long id, TicketLine line)
        {
            ...
            // Javi: No, si el ticket no existe, no debería añadirlo
            CreateTicketBodyWithId(id);
            var lines = _ticketBodies[id]._lines;
            // Javi: Mal, ..., creo que estás mezclando el concepto de index con el concepto de id
        ...
        public bool TryGetTicketHeaderWithID(long id, out TicketHeader header)
        {
            ...
            // Javi: MAL!!!!!!!!!!!!!!!!!!!!!
            // Javi: MAL!!!!!!!!!!!!!!!!!!!!!
            // Javi: Pero no es un diccionario!?!?!?!?!?!?!??!!?!?!?!?!?!?
