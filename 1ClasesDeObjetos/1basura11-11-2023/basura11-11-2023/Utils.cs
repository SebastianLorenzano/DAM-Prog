...
namespace basura11_11_2023
{
    ...
    {
        public static bool EsMenor(int min, int max)
        {
            if (min < max)
                return true;
            return false;
        ...
        public static bool EsMenor3(int min, int num1, int num2)
        {
            return false;
        }
        ...
        public static void Serie1(int num)
        {
        ...
        /* Manera alternativa para hacer RemoveValues 

        public static void RemoveValues(List<int> ñ, List<int> values)
        {
            for (int i=0; l< l.Count; i++)
